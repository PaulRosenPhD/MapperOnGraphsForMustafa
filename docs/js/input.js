...
function load_datasets( callback=null ){
    d3.json( "data/datasets.json", function( dinput ) {
        ...
        document.getElementById("datafile").innerHTML = construct_options_array( Object.keys(datasets) );
...
function update_filter_functions(){
    ...
    if( document.getElementById("filter_func") != null ){
        document.getElementById("filter_func").innerHTML = construct_options_dict(datasets[df]);
    }
}
